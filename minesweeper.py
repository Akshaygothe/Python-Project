...
class Board:
    def __init__(self, dim_size, num_bombs):
        # Lets keep track of these parameters. They'll be helpful letar
        ...
        # initilize a set to keep track of which locations we have uncoverd
        # we will save (row, col) tuples into this set
        self.dug = set() # if we dig at 0, 0 then self.dug = {(0, 0)}

    def make_new_board(self):
        # construct a new board based on the size and num bombs
        # we should construct the list of lists here (or whatever represantaion you prefer,
        # but since we have 2-D board, list of list is most natural)
    ...
    def assign_values_to_board(self):
        # now that we have the bombs planted, lets assign a number 0-8 for all the empty space
        # represents how many neighboring bombs there are. we can precompute thses and it'll same
    ...
    def get_num_neighboring_bombs(self, row, col):
        ...
        # lets iterate through each of the neighboring positions and sum numbers
    ...
    def dig(self, row, col):
        ...
        self.dug.add((row, col)) # keep track that we dug her
...
def play( dim_size=10, num_bombs=10):
    ...
    # Step 3b: if location is not a bom. dig recursively until each square at least
    # next to a bomb 
    ...
    if safe:
        print("Congratuations!!! You are Victorious!")
    else:
        print("Sorry Game Over :(")
        # Lets revel the whole board!
